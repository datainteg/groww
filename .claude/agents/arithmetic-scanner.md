...
**Your focus here**
- Scan `backend/analysis/**` (indicators, patterns, decision/direction engines),
  `backend/utils/risk_manager.py`, and `backend/services/paper_broker.py` for arithmetic.
- Project quantities that mix easily: index **points**, **₹ price**, **percent** (0–100 vs
  0–1), **lots vs quantity** (lot size!), option **premium**, **P&L (₹)**, **bps**, and the
  confidence fraction-vs-percent bug. Flag every site where these combine.
